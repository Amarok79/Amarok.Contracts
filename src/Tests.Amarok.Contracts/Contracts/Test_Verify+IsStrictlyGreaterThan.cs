...
public partial class Test_Verify
{
    ...
    public class IsStrictlyGreaterThan_Int32
    {
        ...
        {
            Check.ThatCode(() => Verify.IsStrictlyGreaterThan(101, 100, "name"))
               .DoesNotThrow();
        }
    ...
    public class IsStrictlyGreaterThan_Int64
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.IsStrictlyGreaterThan(101, (Int64) 100, "name"))
               .DoesNotThrow();
        }
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.IsStrictlyGreaterThan(100, (Int64) 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.IsStrictlyGreaterThan(99, (Int64) 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
    ...
    public class IsStrictlyGreaterThan_Double
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.IsStrictlyGreaterThan(101, (Double) 100, "name"))
               .DoesNotThrow();
        }
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.IsStrictlyGreaterThan(100, (Double) 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.IsStrictlyGreaterThan(99, (Double) 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
    ...
    public class Debug_IsStrictlyGreaterThan_Int32
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(101, 100, "name"))
               .DoesNotThrow();
        }
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(100, 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(99, 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
    ...
    public class Debug_IsStrictlyGreaterThan_Int64
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(101, (Int64) 100, "name"))
               .DoesNotThrow();
        }
        ...
        {
            var exception = Check.ThatCode(
                    () => Verify.Debug.IsStrictlyGreaterThan(100, (Int64) 100, "name")
                )
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
        ...
        {
            var exception = Check
               .ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(99, (Int64) 100, "name"))
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
    ...
    public class Debug_IsStrictlyGreaterThan_Double
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsStrictlyGreaterThan(101, (Double) 100, "name"))
               .DoesNotThrow();
        }
        ...
        {
            var exception = Check.ThatCode(
                    () => Verify.Debug.IsStrictlyGreaterThan(100, (Double) 100, "name")
                )
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
        ...
        {
            var exception = Check.ThatCode(
                    () => Verify.Debug.IsStrictlyGreaterThan(99, (Double) 100, "name")
                )
               .Throws<ArgumentExceedsLowerLimitException>()
               .Value;
    ...
    public class Debug_IsStrictlyGreaterThan_TimeSpan
    {
        ...
        {
            Check.ThatCode(
                    () => Verify.Debug.IsStrictlyGreaterThan(
                        TimeSpan.FromTicks(101),
                        TimeSpan.FromTicks(100),
                        "name"
                    )
