...
public partial class Test_Verify
{
    ...
    public class IsLessThan_Int32
    {
        ...
        {
            Check.ThatCode(() => Verify.IsLessThan(100, 100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.IsLessThan(99, 100, "name")).DoesNotThrow();
        }
    ...
    public class IsLessThan_Int64
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.IsLessThan(100, (Int64)100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.IsLessThan(99, (Int64)100, "name")).DoesNotThrow();
        }
    ...
    public class IsLessThan_Double
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.IsLessThan(100, (Double)100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.IsLessThan(99, (Double)100, "name")).DoesNotThrow();
        }
    ...
    public class Debug_IsLessThan_Int32
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsLessThan(100, 100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.Debug.IsLessThan(99, 100, "name")).DoesNotThrow();
        }
    ...
    public class Debug_IsLessThan_Int64
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsLessThan(100, (Int64)100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.Debug.IsLessThan(99, (Int64)100, "name")).DoesNotThrow();
        }
    ...
    public class Debug_IsLessThan_Double
    {
        ...
        public void DoesNotThrow()
        {
            Check.ThatCode(() => Verify.Debug.IsLessThan(100, (Double)100, "name")).DoesNotThrow();

            Check.ThatCode(() => Verify.Debug.IsLessThan(99, (Double)100, "name")).DoesNotThrow();
        }
    ...
    public class Debug_IsLessThan_TimeSpan
    {
        ...
        {
            var exception = Check.ThatCode(
                    () => Verify.Debug.IsLessThan(TimeSpan.FromTicks(101), TimeSpan.FromTicks(100), "name")
                )
                .Throws<ArgumentExceedsUpperLimitException>()
                .Value;
